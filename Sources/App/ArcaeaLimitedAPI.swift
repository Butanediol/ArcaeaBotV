...
extension Application {
    ...
    struct ArcaeaLimitedAPI {
    	...
    	private func request(endpoint: Endpoint, httpMethod: String, parameters: [String: String] = [:]) throws -> ClientResponse {
		...
		private func get(endpoint: Endpoint, parameters: [String: String] = [:]) throws -> ClientResponse{
...
enum Endpoint {
		...
		var path: String {
			switch self {
				...
				case .score(let difficulty, let friend_code, let songId):
